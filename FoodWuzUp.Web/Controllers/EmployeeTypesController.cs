...
namespace FoodWuzUp.Web.Controllers
{
    public class EmployeeTypesController : BaseController<EmployeeType>
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description")] EmployeeType employeeType)
        {
            if (ModelState.IsValid)
            {
